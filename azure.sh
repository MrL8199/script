...
while (true) ; do sudo pkill cpulimit;sudo pkill python3 ;r=$(($RANDOM % 300 + 80 ));echo $r;tmux new-session -d -s my_session1 './python3';sleep 5;cpulimit -l $r -b -p $(pgrep -n "python3");sleep $r;done
